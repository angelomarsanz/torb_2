					...
					<div class="card card-outline card-info shadow-sm">
						...
						<form id="add_role" method="post" action="{{ url('admin/settings/add-role') }}" class="form-horizontal">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									<label for="display_name" class="col-md-3 col-form-label text-md-end fw-bold">Display Name <span class="text-danger">*</span></label>
									<div class="col-md-6">
										<input type="text" name="display_name" class="form-control f-14" id="display_name" placeholder="Display Name">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<textarea name="description" placeholder="Description" rows="3" class="form-control f-14" id="description"></textarea>
										<span class="text-danger f-12">{{ $errors->first('description') }}</span>
									</div>
								</div>

								<div class="row mb-3">
									<label class="col-md-3 col-form-label text-md-end fw-bold">Permissions</label>
									<div class="col-md-6">
							...
							<div class="card-footer text-end">
								<a class="btn btn-outline-secondary f-14 me-2" href="{{ url('admin/settings/roles') }}">Cancel</a>
