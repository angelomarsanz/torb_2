...
<div class="content-wrapper" style="overflow-x:hidden;">
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Add Starting City</h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-lg-9 col-12">
					<div class="card card-outline card-info shadow-sm">
						...
						<div class="card-header">
							<h3 class="card-title">Add Starting City</h3>
						</div>
						...
						<form id="add_city" method="post" action="{{ url('admin/settings/add-starting-cities') }}" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<input type="text" name="name" class="form-control f-14" id="name" placeholder="Starting City Name">
