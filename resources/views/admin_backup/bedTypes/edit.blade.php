				...
				<div class="col-lg-9 col-12">
					<div class="card card-outline card-info shadow-sm">
						...
						<div class="card-header">
							<h3 class="card-title">Edit Bed Type</h3>
						</div>
						...
						<form id="edit_bed" method="post" action="{{ url('admin/settings/edit-bed-type/' . $result->id) }}" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									<label for="status" class="col-md-3 col-form-label text-md-end fw-bold">Status <span class="text-danger">*</span></label>
									<div class="col-md-6">
							...
							<div class="card-footer text-end">
								<a class="btn btn-outline-secondary f-14 me-2" href="{{ url('admin/settings/bed-type') }}">Cancel</a>
