						...
						<form id="edit_banners" method="post" action="{{ url('admin/settings/edit-banners/' . $result->id) }}" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<input type="text" name="heading" class="form-control f-14" id="heading" placeholder="Heading" value="{{ $result->heading }}">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<input type="text" name="subheading" class="form-control f-14" id="subheading" placeholder="Subheading" value="{{ $result->subheading }}">
