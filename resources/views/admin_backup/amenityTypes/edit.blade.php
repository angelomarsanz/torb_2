...
<div class="content-wrapper" style="overflow-x:hidden;">
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Edit Amenity Type</h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-lg-9 col-12">
					<div class="card card-outline card-info shadow-sm">
						...
						<div class="card-header">
							<h3 class="card-title">Edit Amenity Type</h3>
						</div>
						...
						<form id="amenity_type" method="post" action="{{ url('admin/settings/edit-amenities-type', $result->id) }}" class="form-horizontal">
							...
							<div class="card-footer text-end">
								<a class="btn btn-outline-secondary f-14 me-2" href="{{ url('admin/settings/amenities-type') }}">Cancel</a>
