				...
				<div class="col-12">
					<div class="card card-outline card-info shadow-sm">
						...
						<div class="card-header">
							<h3 class="card-title">Amenity Edit Form</h3>
						</div>
						...
						<form id="edit_amen" method="post" action="{{ url('admin/edit-amenities/' . $result->id) }}" class="form-horizontal">
							...
							<div class="card-body">
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<input type="text" name="title" class="form-control f-14" id="title" placeholder="Name" value="{{ $result->title }}">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<textarea name="description" placeholder="Description" rows="3" class="form-control f-14">{{ $result->description }}</textarea>
