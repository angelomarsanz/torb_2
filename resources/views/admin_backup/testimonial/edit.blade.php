...
<div class="content-wrapper" style="overflow-x:hidden;">
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Testimonial <small class="text-muted fw-normal">Edit Testimonial</small></h1>
				</div>
				<div class="col-sm-6">
				...
				<div class="col-12">
					<div class="card card-outline card-info shadow-sm">
						...
						<div class="card-header">
							<h3 class="card-title">Testimonial Edit Form</h3>
						</div>
						...
						<form class="form-horizontal" action="{{ url('admin/edit-testimonials/' . $result->id) }}" id="edit_testimonials" method="post" name="edit_testimonials" accept-charset="UTF-8" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<textarea name="description" id="description" class="form-control f-14" rows="4" placeholder="Description..">{{ $result->description }}</textarea>
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										...
										@if ($result->image)
											<div class="mt-2">
												<img src="{{ url('/public/front/images/testimonial/' . $result->image) }}" alt="Testimonial" class="img-thumbnail" height="80" width="80">
											</div>
										@endif
