						...
						<form id="add_language" method="post" action="{{ url('admin/settings/add-language') }}" class="form-horizontal">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6">
										<input type="text" name="short_name" class="form-control f-14" id="short_name" placeholder="Short Name">
							...
							<div class="card-footer text-end">
								<a class="btn btn-outline-secondary f-14 me-2" href="{{ url('admin/settings/language') }}">Cancel</a>
