											...
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Admin User</h4>
															<p class="settings-form-subtitle">Create a new administrative
																account with specific roles and permissions</p>
														</div>
													</div>
												</div>
												...
												<div class="settings-form-body">
													...
													<div class="settings-section">
														...
														{{-- Password --}}
														<div class="settings-field-row">
															<label for="password" class="settings-field-label">Password
																<span class="text-danger">*</span></label>
															<div class="settings-field-input">
