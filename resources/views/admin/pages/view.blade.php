	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner">
				<h1 class="dashboard-page-title">PAGES</h1>
			</div>
		</section>
							...
							<div class="settings-form-header">
								<div class="d-flex justify-content-between align-items-center">
									<div class="d-flex align-items-center gap-3">
										...
										<div>
											<h4 class="settings-form-title">Content Pages</h4>
											<p class="settings-form-subtitle">Manage static content pages like Privacy Policy, Terms, and About Us</p>
										</div>
									</div>
									<a class="btn settings-btn-save" href="{{ url('admin/add-page') }}">
