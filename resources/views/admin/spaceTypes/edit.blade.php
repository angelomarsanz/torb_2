	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">EDIT SPACE TYPE</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Edit Space Type</h4>
														<p class="settings-form-subtitle">Modify the details and configuration for the {{ $result->name }} space type</p>
													</div>
												</div>
											</div>
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="name" class="form-control settings-input" id="name" placeholder="Entire home, Private room..." value="{{ $result->name }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<textarea name="description" placeholder="Describe what this space type includes..." rows="3" class="form-control settings-input" id="description" style="height: auto !important;">{{ $result->description }}</textarea>
											...
											<div class="settings-form-footer">
												<div class="d-flex align-items-center gap-2">
													...
													<a class="btn settings-btn-cancel" href="{{ url('admin/settings/space-type') }}">Cancel</a>
												</div>
												</div>
											</div>
										</div>
