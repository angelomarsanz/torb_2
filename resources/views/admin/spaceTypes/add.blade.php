		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">ADD SPACE TYPE</h1>
				</div>
			</section>
							...
							<div class="card-body p-4 pt-3">
								<div class="workbench-container">
									...
									<div class="workbench-main">
										...
										<form id="add_space" method="post"
											action="{{ url('admin/settings/add-space-type') }}" class="form-horizontal"
											...
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Space Type</h4>
															<p class="settings-form-subtitle">Registered a new type of space
																(e.g., Entire Home, Private Room) for listings</p>
														</div>
													</div>
												</div>
														...
														<div class="settings-field-row">
															...
															<div class="settings-field-input">
																<textarea name="description"
																	placeholder="Describe what this space type includes..."
												...
												<div class="settings-form-footer">
													<div class="d-flex align-items-center gap-2">
														...
														<a class="btn settings-btn-cancel"
															href="{{ url('admin/settings/space-type') }}">Cancel</a>
													</div>
													<small class="text-muted d-none d-md-block"
														style="font-size: 11.5px; opacity: 0.7;">This defines the privacy
														level for guests</small>
												</div>
											</div>
										</form>
									</div>
