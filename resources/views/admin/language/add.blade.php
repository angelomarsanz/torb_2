		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">ADD LANGUAGE</h1>
				</div>
			</section>
							...
							<div class="card stunning-table-card rounded-4 border-0 shadow-sm mb-0">
								<div class="card-body p-4 pt-3">
									<div class="workbench-container">
										...
										<form id="add_language" method="post"
											action="{{ url('admin/settings/add-language') }}" class="form-horizontal">
											{{ csrf_field() }}
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Language Form</h4>
															<p class="settings-form-subtitle">Register a new language for
																platform localization and content translation</p>
														</div>
													</div>
												</div>
												...
												<div class="settings-form-body">
													...
													<div class="settings-section">
														...
														<div class="settings-field-row">
															...
															<div class="settings-field-input">
																<input type="text" name="name"
																	...
																	placeholder="English" value="{{ old('name') }}">
																<span
														...
														{{-- Short Name --}}
														<div class="settings-field-row">
															<label for="short_name" class="settings-field-label">Short Name
																<span class="text-danger">*</span></label>
															<div class="settings-field-input">
																<input type="text" name="short_name"
																	class="form-control settings-input" id="short_name"
																	placeholder="en" value="{{ old('short_name') }}">
																<span
																	class="text-danger f-12">{{ $errors->first("short_name") }}</span>
															</div>
														</div>
													</div>
												...
												<div class="settings-form-footer">
													<div class="d-flex align-items-center gap-2">
														...
														<a class="btn settings-btn-cancel"
															href="{{ url('admin/settings/language') }}">Cancel</a>
													</div>
													<small class="text-muted d-none d-md-block"
														style="font-size: 11.5px; opacity: 0.7;">Ensure local files exist
														for the short name</small>
												</div>
											</div>
										</form>
									</div>
