	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">EDIT LANGUAGE</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Edit Language Form</h4>
														<p class="settings-form-subtitle">Modify the identity and status for the {{ $result->name }} language</p>
													</div>
												</div>
											</div>
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="name" class="form-control settings-input" id="name" placeholder="English" value="{{ $result->name }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="short_name" class="form-control settings-input" id="short_name" placeholder="en" value="{{ $result->short_name }}">
											...
											<div class="settings-form-footer">
												<div class="d-flex align-items-center gap-2">
													...
													<a class="btn settings-btn-cancel" href="{{ url('admin/settings/language') }}">Cancel</a>
												</div>
												</div>
											</div>
										</div>
