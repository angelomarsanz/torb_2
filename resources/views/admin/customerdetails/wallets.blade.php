						...
						<div class="settings-form-card">
							<div class="settings-form-header">
								<div class="d-flex align-items-center gap-3">
									...
									<div>
										<h4 class="settings-form-title">Wallet Transactions</h4>
										<p class="settings-form-subtitle">History of all transactions and balance changes for this customer</p>
									</div>
								</div>
							</div>
							<div class="settings-form-body p-0">
								<div class="table-responsive parent-table filters-parent f-14 p-4">
