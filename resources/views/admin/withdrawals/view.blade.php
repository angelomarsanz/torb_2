	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner">
				<h1 class="dashboard-page-title">WITHDRAWALS</h1>
			</div>
		</section>
						...
						<div class="settings-form-card mb-5">
							<div class="settings-form-header">
								<div class="d-flex align-items-center gap-3">
									...
									<div>
										<h4 class="settings-form-title">Withdrawal Requests</h4>
										<p class="settings-form-subtitle">Monitor and authorize host payout withdrawal requests from their wallet balance</p>
									</div>
								</div>
							</div>
