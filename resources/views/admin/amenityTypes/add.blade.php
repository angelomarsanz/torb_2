		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">ADD AMENITY TYPE</h1>
				</div>
			</section>
							...
							<div class="card-body p-4 pt-3">
								<div class="workbench-container">
									...
									<div class="workbench-main">
										...
										<form id="add_amenity" method="post"
											action="{{ url('admin/settings/add-amenities-type') }}" class="form-horizontal">
											{{ csrf_field() }}
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Amenity Type</h4>
															<p class="settings-form-subtitle">Define a new category to group
																related property features and services</p>
														</div>
													</div>
												</div>
												...
												<div class="settings-form-body">
													...
													{{-- Section: Amenity Type Details --}}
													<div class="settings-section">
														<div class="settings-section-label">
															<i class="fa fa-info-circle"></i>
															<span>Amenity Type Information</span>
														</div>
														...
														<div class="settings-field-row">
															...
															<div class="settings-field-input">
																<input type="text" name="name"
																	...
																	placeholder="Common, Safety, Extras...">
																<span
														...
														<div class="settings-field-row">
															<label for="description"
																class="settings-field-label">Description <span
																	class="text-danger">*</span></label>
															<div class="settings-field-input">
																<textarea name="description"
																	placeholder="Briefly describe what this amenity type includes..."
																	rows="3" class="form-control settings-input"
																	id="description"
												...
												<div class="settings-form-footer">
													<div class="d-flex align-items-center gap-2">
														...
														<a class="btn settings-btn-cancel"
															href="{{ url('admin/settings/amenities-type') }}">Cancel</a>
													</div>
												</div>
											</div>
										</form>
