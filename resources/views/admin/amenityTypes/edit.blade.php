		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">EDIT AMENITY TYPE</h1>
				</div>
			</section>
							...
							<div class="card-body p-4 pt-3">
								<div class="workbench-container">
									...
									<div class="workbench-main">
										...
										<form id="amenity_type" method="post"
											action="{{ url('admin/settings/edit-amenities-type', $result->id) }}"
											...
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Edit Amenity Type</h4>
															<p class="settings-form-subtitle">Modify the details and
																configuration for the {{ $result->name }} category</p>
														</div>
													</div>
												</div>
														...
														<div class="settings-field-row">
															...
															<div class="settings-field-input">
																<textarea name="description" placeholder="Description"
																	...
																	id="description"
																	style="height: auto !important;">{{ $result->description }}</textarea>
																<span
