											...
											<div class="d-flex justify-content-between align-items-center">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														...
														<p class="settings-form-subtitle">Manage the list of features and
															services hosts can highlight in their listings</p>
													</div>
												</div>
												<a class="btn settings-btn-save" href="{{ url('admin/add-amenities') }}">
													<i class="fa fa-plus me-2"></i>Add Amenities
												</a>
											</div>
										</div>
