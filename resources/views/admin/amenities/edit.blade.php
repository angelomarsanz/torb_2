		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">EDIT AMENITIES</h1>
				</div>
			</section>
						...
						<div class="col-lg-8 col-12 mx-auto">
							<div class="card stunning-table-card rounded-4 border-0 shadow-sm mb-0">
								<div class="card-body p-4 pt-3">
									...
									<form id="edit_amenities" method="post"
										action="{{ url('admin/edit-amenities/' . $result->id) }}" class="form-horizontal">
										{{ csrf_field() }}
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Edit Amenity</h4>
													</div>
												</div>
											</div>
														...
														<div class="settings-field-input">
															<select class="form-select settings-input" id="type_id"
																...
																@foreach ($amenities_type as $row)
																	<option value="{{ $row->id }}" {{ $row->id == $result->type_id ? 'selected' : '' }}>{{ $row->name }}</option>
																@endforeach
															</select>
															<span
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="symbol"
																...
																placeholder="fa fa-wifi" value="{{ $result->symbol }}">
															<span
