	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">ADD ROLE</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Add Role</h4>
														<p class="settings-form-subtitle">Create a new administrative role and define its access permissions</p>
													</div>
												</div>
											</div>
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="name" class="form-control settings-input" id="name" placeholder="role_name (e.g., editor)">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="display_name" class="form-control settings-input" id="display_name" placeholder="User Friendly Name">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<textarea name="description" placeholder="What this role can do..." rows="3" class="form-control settings-input" id="description" style="height: auto !important;"></textarea>
											...
											<div class="settings-form-footer">
												...
												<small class="text-muted d-none d-md-block" style="font-size: 11.5px; opacity: 0.7;">Carefully assign permissions</small>
											</div>
										</div>
									</form>
								</div>
