	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">EDIT COUNTRY</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Edit Country</h4>
														<p class="settings-form-subtitle">Modify the details and identity codes for {{ $result->name }}</p>
													</div>
												</div>
											</div>
											...
											<div class="settings-form-body">
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="short_name" class="form-control settings-input" id="short_name" placeholder="US" value="{{ $result->short_name }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="name" class="form-control settings-input" id="name" placeholder="United States" value="{{ $result->name }}">
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="iso3" class="form-control settings-input" id="iso3" placeholder="USA" value="{{ $result->iso3 }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="number_code" class="form-control settings-input" id="number_code" placeholder="840" value="{{ $result->number_code }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															<input type="text" name="phone_code" class="form-control settings-input" id="phone_code" placeholder="1" value="{{ $result->phone_code }}">
