	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">SEO METAS</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Search Engine Optimization</h4>
														<p class="settings-form-subtitle">Optimize your site's visibility with custom meta titles and descriptions for key pages</p>
													</div>
												</div>
											</div>
