	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">EDIT STARTING CITY</h1>
			</div>
		</section>
										...
										<div class="settings-form-card">
											...
											<div class="settings-form-header">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h4 class="settings-form-title">Edit Starting City</h4>
														<p class="settings-form-subtitle">Modify the details and featured image for {{ $result->name }}</p>
													</div>
												</div>
											</div>
											...
											<div class="settings-form-body">
												...
												<div class="settings-section">
													...
													<div class="settings-field-row">
														<label for="name" class="settings-field-label">City Name <span class="text-danger">*</span></label>
														<div class="settings-field-input">
															<input type="text" name="name" class="form-control settings-input" id="name" placeholder="City Name" value="{{ $result->name }}">
													...
													<div class="settings-field-row">
														...
														<div class="settings-field-input">
															...
															<div class="mt-3 p-2 bg-light rounded-3 d-inline-block border">
																...
																<img class="img-fluid rounded-2 shadow-sm" style="max-height: 100px;" src="{{ url('public/front/images/starting_cities/' . $result->image) }}">
															</div>
															<small class="text-muted d-block mt-2" style="font-size: 11px;">Recommended Dimensions: 442x310px</small>
														</div>
													</div>
												</div>
											...
											<div class="settings-form-footer">
												<div class="d-flex align-items-center gap-2">
													...
													<a class="btn settings-btn-cancel" href="{{ url('admin/settings/starting-cities') }}">Cancel</a>
												</div>
												</div>
											</div>
										</div>
