		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">ADD STARTING CITY</h1>
				</div>
			</section>
							...
							<div class="card stunning-table-card rounded-4 border-0 shadow-sm mb-0">
								<div class="card-body p-4 pt-3">
									<div class="workbench-container">
										...
										<form id="add_starting_city" method="post"
											action="{{ url('admin/settings/add-starting-cities') }}" class="form-horizontal"
											...
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Starting City</h4>
															<p class="settings-form-subtitle">Register a new featured city
																to be displayed on the platform homepage</p>
														</div>
													</div>
												</div>
												...
												<div class="settings-form-body">
													...
													<div class="settings-section">
														...
														<div class="settings-field-row">
															<label for="name" class="settings-field-label">City Name <span
													...
													<div class="settings-section">
														...
														{{-- Image --}}
														<div class="settings-field-row">
															<label for="image" class="settings-field-label">City Image <span
																	class="text-danger">*</span></label>
															<div class="settings-field-input">
												...
												<div class="settings-form-footer">
													<div class="d-flex align-items-center gap-2">
														...
														<a class="btn settings-btn-cancel"
															href="{{ url('admin/settings/starting-cities') }}">Cancel</a>
													</div>
													<small class="text-muted d-none d-md-block"
														style="font-size: 11.5px; opacity: 0.7;">Cities will appear on the
														homepage exploration section</small>
												</div>
											</div>
										</form>
									</div>
