	...
	<div class="dashboard-content-inner">
		<section class="content-header dashboard-page-header">
			<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
				<h1 class="dashboard-page-title m-0">BED TYPES</h1>
			</div>
		</section>
											...
											<div class="settings-form-header">
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Bed Types</h4>
															<p class="settings-form-subtitle">Define various bed configurations for room setup (King, Queen, Single, etc.)</p>
														</div>
													</div>
													<a class="btn settings-btn-save" href="{{ url('admin/settings/add-bed-type') }}">
														<i class="fa fa-plus me-2"></i>Add Bed Type
													</a>
												</div>
											</div>
