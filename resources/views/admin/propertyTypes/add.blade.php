		...
		<div class="dashboard-content-inner">
			<section class="content-header dashboard-page-header">
				<div class="dashboard-header-inner w-100 d-flex justify-content-between align-items-center">
					<h1 class="dashboard-page-title m-0">ADD PROPERTY TYPE</h1>
				</div>
			</section>
							...
							<div class="card-body p-4 pt-3">
								<div class="workbench-container">
									...
									<div class="workbench-main">
										...
										<form id="add_property" method="post"
											action="{{ url('admin/settings/add-property-type') }}" class="form-horizontal"
											...
											<div class="settings-form-card">
												...
												<div class="settings-form-header">
													<div class="d-flex align-items-center gap-3">
														...
														<div>
															<h4 class="settings-form-title">Add Property Type</h4>
															<p class="settings-form-subtitle">Define a new category of
																property that can be listed on the platform</p>
														</div>
													</div>
												</div>
														...
														<div class="settings-field-row">
															...
															<div class="settings-field-input">
																<textarea name="description"
																	placeholder="Briefly describe this property type..."
												...
												<div class="settings-form-footer">
													<div class="d-flex align-items-center gap-2">
														...
														<a class="btn settings-btn-cancel"
															href="{{ url('admin/settings/property-type') }}">Cancel</a>
													</div>
													<small class="text-muted d-none d-md-block"
														style="font-size: 11.5px; opacity: 0.7;">This will be visible to
														hosts during listing creation</small>
												</div>
											</div>
										</form>
									</div>
