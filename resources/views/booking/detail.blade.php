		...
		<div class="col-md-8 card p-5">
			...
			<div class="row flex-column-reverse flex-md-row mt-4 m-0">
				...
				<div class="mt-5 text-center text-sm-left">
					<button class="btn vbtn-outline-success text-16 font-weight-700 px-5 pt-3 pb-3 mt-4" id="accept-modal-trigger">
					{{ __('Accept') }}
					</button>
					<button class="btn btn-outline-danger text-16 font-weight-700 px-5 pt-3 pb-3 mt-4 ml-0 ml-sm-4" id="decline-modal-trigger">
					{{ __('Decline') }}
					</button>
				</div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="border p-2 mt-3 rounded-3">
                        <div class="d-flex justify-content-between text-16">
                            ...
                            <div>
                                <p class="px-4">{{ $result->total_night }}</p>
                            </div>
                        </div>
                        ...
                        @if ($result->host_fee)
                            <div class="d-flex justify-content-between text-16">
                                ...
                                <div>
                                    <p class="px-4">{!! $result->currency->symbol !!}{{ $result->host_fee }}</p>
                                </div>
                            </div>
                        @endif
					...
					<form accept-charset="UTF-8" action="{{ url('booking/accept/' . $booking_id) }}" id="accept_reservation_form" method="post" name="accept_reservation_form">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="row mt-4">
									...
									<div class="col-sm-11 p-0 text-16 text-justify">
										<label class="label-inline" for="tos_confirm">{{ __('By checking this box, I agree to the') }} <br><a href="{{ url('host-guarantee-terms-and-conditions') }}" target="_blank" class="font-weight-700">{{ __('Host Guarantee Terms and Conditions') }}</a> <br><a href="{{ url('guest-refund-policy-terms') }}" target="_blank" class="font-weight-700">{{ __('Guest Refund Policy Terms') }}</a>, {{ __('and') }} <a href="{{ url('terms-of-service') }}" target="_blank" class="font-weight-700">{{ __('Terms of Service') }}</a>.</label>
									</div>
								</div>
							</div>
							...
							<div class="col-md-12 text-right mt-4">
								...
								<button type="button" class="btn btn-outline-danger text-16 font-weight-700 px-5 pt-2 pb-2 mt-4 ml-2" data-dismiss="modal">{{ __('Close')  }}</button>

								<button type="submit" class="btn vbtn-outline-success text-16 font-weight-700 px-5 pt-2 pb-2 mt-4 mr-2" id="accept_submit" name="commit"> <i class="spinner fa fa-spinner fa-spin d-none" id="accept_spinner" ></i>
				...
				<div class="modal-body p-4">
					<div class="row">
						...
						<div class="col-md-12 mt-5 text-right">
							...
							<button type="button" class="btn btn-outline-danger text-16 font-weight-700 px-5 pt-2 pb-2 ml-2" data-dismiss="modal">{{ __('Close') }}</button>

							<button type="submit" class="btn vbtn-outline-success text-16 font-weight-700 px-5 pt-2 pb-2 mr-2" id="decline_submit" name="commit"> <i class="spinner fa fa-spinner fa-spin d-none" id="decline_spinner" ></i>
