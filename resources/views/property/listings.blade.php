                                ...
                                <div class=" row  border p-2 rounded-3">
                                    ...
                                    <div class="col-md-6 col-xl-6 p-2">
                                        ...
                                        <ul class="list-inline mt-2 pb-3">
                                            <li class="list-inline-item border rounded-3 py-1 mt-4 px-3">
                                                        ...
                                                        <div class="main-toggle-switch text-left text-sm-center">
                                                            @if ($property->steps_completed == 0)
                                                                @if ($property_approval == 'Yes' && $property->is_verified == 'Pending' )
                                                                    <span class="badge badge-warning px-4 py-3 text-14 border-r-25">{{ __('Waiting for verify') }}</span>
                                                                @else
                                                                    <label class="toggleSwitch large" onclick="">
                                                                        ...
                                                                        <a href="javascript: void(0)" aria-label="toggle"></a>
                                                                    </label>
                                                                @endif
                                                            @else
                                                            <span class="badge badge-warning px-4 py-3 text-14 border-r-25">{{ $property->steps_completed }} {{ __('steps to listed') }}</span>
                                                            @endif
                                                        </div>
                                                    </div>
