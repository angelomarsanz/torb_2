...
@section('validation_script')
    <script type="text/javascript">
        // Directly initialize the Google Map on the single property page
        function onGoogleMapsReady() {
            window.googleMapsReady = true;
            initSinglePropertyMap();
        }

        function initSinglePropertyMap() {
            var lat = parseFloat(typeof latitude !== 'undefined' ? latitude : 0);
            var lng = parseFloat(typeof longitude !== 'undefined' ? longitude : 0);
            var mapCenter = { lat: lat, lng: lng };

            var map = new google.maps.Map(document.getElementById('room-detail-map'), {
                center: mapCenter,
                zoom: 14,
                scrollwheel: false,
            ...
            // Draw a teal semi-transparent circle around the property location
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{ config('vrent.google_map_key') }}&libraries=places&loading=async&callback=onGoogleMapsReady" async defer></script>
    @auth
