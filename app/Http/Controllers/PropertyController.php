...
class PropertyController extends Controller
{
    ...
    public function single(Request $request)
    {
        ...
        if ($data['result']->users?->status == 'Inactive' ) {
            ...
            //-- right now property dates are not updated automatically so we are not calling this function
            ...
            $data['similar'] = Properties::with('property_address')
                                ...
                                ->having('distance', '<=', 30)  // Filter properties within 30 miles radius
                                ->get();
