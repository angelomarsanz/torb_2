...
class UserController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Note: 'accomodation_tax' is misspelled but matches the database column name
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                if ($new_email == 'yes') {
                    ...
                    $this->helper->one_time_message('success', __('Email confirmation mail is sent to your email address'));
                } else {
    ...
    public function accountDefault(Request $request, EmailController $email_controller)
    {
        ...
        if ($account->selected == 'Yes') {
            $this->helper->one_time_message('success', __('Payout account is set to default'));
            return redirect('users/account-preferences');
        } else {
    ...
    public function reviewsByYou(Request $request)
    {
        ...
        // DATEDIFF is a MySQL function to calculate the difference between dates
    ...
    /**
     * Checking duplicate phone number for existing customer during manual booking
     *
