		...
		<div class="col-md-8 col-sm-8 col-xs-12 mb-5 main-panel p-5 border rounded">
			...
			<div class="form-group mt-5">
				<div class="col-sm-8 p-0">
					<button class="btn vbtn-outline-success text-16 font-weight-700 px-5 pt-3 pb-3" id="stripe_btn"><i class="spinner fa fa-spinner fa-spin d-none"></i> {{ __('Submit Payment') }}</button>
				</div>
			</div>
		</form>
		</div>
