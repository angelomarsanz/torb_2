    ...
    public function run()
    {
        ...
        \DB::table('gateways')->insert(array(
            ...
            array(
                ...
                'name' => 'Flutterwave',
                'sandbox' => 1,
                'data' => '{"secretKey":"' . env('SECRETKEY_FLUTTERWAVE', '') . '","publicKey":"' . env('PUBLICKEY_FLUTTERWAVE', '') . '","encryptionKey":"' . env('ENCRYPTIONKEY_FLUTTERWAVE', '') . '":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua","status":"1"}',
                'instruction' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua',
                'image' => 'thumbnail.png',
                'status' => 1,
            ),
            ...
            array(
                ...
                'name' => 'Razorpay',
                'sandbox' => 1,
                'data' => '{"apiKey":"' . env('APIKEY_RAZORPAY', '') . '","apiSecret":"' . env('APISECRET_RAZORPAY', '') . '","instruction":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","status":"1","sandbox":"1"}',
                'instruction' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
                'image' => 'thumbnail.png',
                'status' => 1,
            ),
