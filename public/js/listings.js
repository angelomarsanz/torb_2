...
if(page == 'basics') {
    ...
    function initializeLocationPicker() {
        if (typeof $.fn.locationpicker !== 'undefined' && typeof google !== 'undefined' && typeof google.maps !== 'undefined') {
            ...
            console.log('Waiting for Google Maps and LocationPicker...');
            setTimeout(initializeLocationPicker, 200);
        }
    }
        ...
        if (photo_file != ''){
            ...
            success: function (result) {
                if (result.status) {
                    ...
                    +'<a class="photo-delete" href="javascript:void(0)" data-rel="'+result.photo_id+'"><p class="photo-delete-icon"><i class="fa fa-trash-o"></i></p></a>'
                    +'</div>'
    ...
    $('#lis_pricing').validate({
        ...
        errorPlacement: function (error, element) {
            if (element.parent('.stunning-input-group').length) {
                error.insertAfter(element.parent('.stunning-input-group'));
            } else {
