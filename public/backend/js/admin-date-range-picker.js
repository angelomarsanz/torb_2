...
$(function() {
    ...
    $(document).ready(function(){
        $('#dataTableBuilder_length').after('<div id="exportArea" class="d-inline-flex ms-3 gap-2 align-items-center"><div class="btn-group"><button type="button" class="btn settings-btn-export h-42 px-4 dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" aria-haspopup="true">Export</button><ul class="dropdown-menu wb-dropdown-menu"><li><a class="wb-dropdown-item" href="" title="CSV" id="csv"><i class="fa fa-file-text-o"></i> CSV</a></li><li><a class="wb-dropdown-item" href="" title="PDF" id="pdf"><i class="fa fa-file-pdf-o"></i> PDF</a></li></ul></div><a href="" id="tablereload" class="btn settings-btn-outline h-42 px-3 d-flex align-items-center justify-content-center"><i class="fa fa-refresh"></i></a></div>');
