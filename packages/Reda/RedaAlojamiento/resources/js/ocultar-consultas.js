...
(function( $ ) {
    ...
    /**
     * Ejecuta el filtrado con un pequeño retraso para evitar ejecuciones masivas.
     */
    ...
    $(function() {
        ...
        const observer = new MutationObserver((mutations) => {
            // Solo actuar si hay cambios en los hijos y no somos nosotros mismos los que modificamos
            const shouldReact = mutations.some(m => m.type === 'childList' && m.target.id !== 'reda-empty-state-message');
            if (shouldReact) debounceFiltrar();
        });
