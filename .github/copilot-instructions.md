...
- **Pautas Técnicas:** Antes de realizar cualquier cambio técnico, estructural o de lógica en cualquier proceso de la aplicación, es OBLIGATORIO leer el archivo `REDA_PAUTAS_DESARROLLO.md`. Este archivo contiene las "Reglas de Oro" y directrices críticas que garantizan la estabilidad, consistencia e integridad de todo el sistema, y su cumplimiento es mandatorio para evitar regresiones o fallos en los flujos de negocio.
